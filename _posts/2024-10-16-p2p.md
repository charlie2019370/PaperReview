...
![3.2]({{ '/assets/img/p2p/3.2.png' | relative_url }})

Recall that the appearance and structural information of the generated image is based on the cross-attention maps. From the figure above, we can see that the pixels show high attention values for the words that describe them. 
