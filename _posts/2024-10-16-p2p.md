...
P2P uses Imagen as the backbone model for text-guided synthesis. Each diffusion step t includes predicting noise ε from noisy image \\(z_t\\) and text embedding ψ(P) using the U-Net, finally generating \\(I=z_0\\).
